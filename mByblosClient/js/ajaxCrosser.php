...
foreach ($allRequestHeader as $key => $value) {
	...
	if (($lowkey == "content-type") || ($lowkey == "accept-language") || ($lowkey == "content-length") || ($lowkey == "user-agent") || ($lowkey == "accept-Language") || ($lowkey == "accept-encoding") || ($lowkey == "accept") || ($lowkey == "cookie") ||
	($lowkey == "connection") || ($lowkey == "pragma")|| ($lowkey == "cache-controls") || ($lowkey == "login") || ($lowkey == "password")) {
		$headers[] = $key . ": " . $value;
	}
}
